...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<List<CategoryDto>> getCategories(@PathVariable String accountId) {
        List<CategoryDto> categories = categoryService.getCategoryOfOwner(UUID.fromString(accountId));
